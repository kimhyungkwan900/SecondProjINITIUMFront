                ...
                <div className="flex-1 ml-10 p-4">
                    ...
                    <div className="overflow-x-auto text-center">
                        ...
                        <tbody>
                            ...
                            <td className="border px-3 py-2">
                                <button onClick={() => openResultModal()} className="bg-blue-700 hover:bg-blue-800 text-white font-medium px-3 py-1 rounded">등록하기</button>
                            </td>
                            </tr>
                        </tbody>
                        </table>
...
export default CnslrConsultListPage;